                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div>
                                        <label for="trc" class="form-label">Temperatura requerida de la carga</label>
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table border="1", width="900">
                                        <tr>
                                            <th>
                                           <label for="producto" class="form-label">Producto por transportar</label>     
                                            </th>
                                            <th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <input type="text" class="form-control" id="producto-1" placeholder="fila 1">    
                                            </td>
                                            
                                            <td>
                                            <input type="text" class="form-control" id="observaciones-1" placeholder="fila 1">  
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="producto-2" placeholder="fila 2">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="observaciones-2" placeholder="fila 2">  
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="producto-3" placeholder="fila 3">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="observaciones-3" placeholder="fila 3">  
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="producto-4" placeholder="fila 4">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="observaciones-4" placeholder="fila 4">  
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="producto-5" placeholder="fila 5">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="observaciones-5" placeholder="fila 5">  
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="producto-6" placeholder="fila 6">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="observaciones-6" placeholder="fila 6">  
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="hidden" type="text" class="form-control" id="producto-7" placeholder="fila 7">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="observaciones-7" placeholder="fila 7">  
                                            </td>
                                    ...
                                    <script>
                                        ...
                                        const observaciones= document.getElementById("observaciones-"+sectionCount);
                                        const productos = document.getElementById("producto-"+sectionCount);
                                ...
                                <div class="col-md-2">
                                    <table border="1", width="900">
                                        ...
                                        <select class="form-select" id="tipcvc-1">
                                            ...
                                            <td>
                                            <input type="text" class="form-control" id="cantcvc-1" placeholder="fila 1">    
                                            </td>
                                            
                                            <td>
                                            <input type="text" class="form-control" id="altocvc-1" placeholder="fila 1">  
                                            </td>
                                            
                                            <td>
                                            <input type="text" class="form-control" id="anchocvc-1" placeholder="fila 1">    
                                            </td>
                                            
                                            <td>
                                            <input type="text" class="form-control" id="largocvc-1" placeholder="fila 1">    
                                            </td>
                                        </tr>
                                        ...
                                        <select class="form-select" id="tipcvc-2" style="display:none">
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="cantcvc-2" placeholder="fila 2">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="altocvc-2" placeholder="fila 2">  
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="anchocvc-2" placeholder="fila 2">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="largocvc-2" placeholder="fila 2">    
                                            </td>
                                        </tr>
                                        ...
                                        <select class="form-select" id="tipcvc-3" style="display: none">
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="cantcvc-3" placeholder="fila 3">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="altocvc-3" placeholder="fila 3">  
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="anchocvc-3" placeholder="fila 3">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="largocvc-3" placeholder="fila 3">    
                                            </td>
                                        </tr>
                                        ...
                                        <select class="form-select" id="tipcvc-4" style="display:none" >
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="cantcvc-4" placeholder="fila 4">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="altocvc-4" placeholder="fila 4">  
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="anchocvc-4" placeholder="fila 4">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="largocvc-4" placeholder="fila 4">    
                                            </td>
                                        </tr>
                                        ...
                                        <select class="form-select" id="tipcvc-5" style="display:none">
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="cantcvc-5" placeholder="fila 5">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="altocvc-5" placeholder="fila 5">  
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="anchocvc-5" placeholder="fila 5">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="largocvc-5" placeholder="fila 5">    
                                            </td>
                                        </tr>
                                        ...
                                        <select class="form-select" id="tipcvc-6" style="display:none">
                                            ...
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="cantcvc-6" placeholder="fila 6">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="altocvc-6" placeholder="fila 6">  
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="anchocvc-6" placeholder="fila 6">    
                                            </td>
                                            
                                            <td>
                                            <input type="hidden" type="text" class="form-control" id="largocvc-6" placeholder="fila 6">    
                                            </td>
                                        </tr>
                                        
                                    </table>
                                    <button class ="btn btn-primary mb-4" id="add-section-btn" onclick="addSection() " type="button" >Agregar Secci�n</button>
                                    <script>
                                        var sectionCount = 1;
                                        function addSection(){
